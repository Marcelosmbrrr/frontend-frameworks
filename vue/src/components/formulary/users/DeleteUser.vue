<template>
    <!-- Modal toggle -->
    <span data-modal-target="delete-user-modal" data-modal-toggle="delete-user-modal" href="#"
        class="font-medium text-blue-600 dark:text-blue-500 hover:underline cursor-pointer">Delete</span>
