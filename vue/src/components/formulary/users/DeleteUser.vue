                    ...
                    <DialogPanel
                        ...
                        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                <div
                                    ...
                                    <font-awesome-icon icon="fa-solid fa-exclamation" class="h-6 w-6 text-white"
                                        aria-hidden="true" />
                                </div>
                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    <DialogTitle as="h3" class="text-base font-semibold leading-6 text-gray-900 text-left">
                                        User Remotion - ID ({{ props.identifier }})</DialogTitle>
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500 text-justify">Are you sure you want to
                                            deactivate this user
                                            account? All of his data will be permanently removed. This action cannot be
                                            undone.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                            <button type="button"
                                ...
                                @click="handleClose">Deactivate</button>
                            <button type="button"
