...
import { RoleController } from '../../controllers/modules/role/RoleController';
        ...
        <HomeLayout>
            <div className='w-full'>
                ...
                <div className="flex justify-between items-center w-full border-b border-gray-700 py-3">
                    <div className='pl-2'>
                        <span className='text-white text-[20px]'>ROLES</span>
                    </div>
                    <div className='flex items-center'>
                        <div>
                            <button type="button" className={`flex items-center text-white ${selected ? "bg-stone-700" : "bg-sky-700 hover:bg-sky-800"} focus:ring-sky-300 font-medium rounded text-sm px-3 py-1.5 mr-2`}>
                    ...
                    <thead className="text-xs text-white uppercase bg-stone-800">
                        <tr>
                            <th scope="col" className="p-4">
                                <div className="flex items-center">
                                    <input id="checkbox-all-search" type="checkbox" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onChange={handleSelectAll} />
