...
export const CardC = React.memo((props) => {

    console.log('Card C rendered.');
    ...
    return (
        <div className='grid grid-rows-[50px_1fr_85px_50px] shadow'>
            <div className='flex items-center border-b-2 border-slate-100 px-2 bg-slate-800'>
                <span className='text-white font-bold mr-1'>CARD C |</span><span className='text-emerald-400 font-bold'>REACT</span><span className='text-white font-bold'>.useCallback()</span>
            </div>
            ...
            <div className='text-md text-gray-600 text-justify p-1 shadow'>
                <p className="text-lg text-gray-600 text-justify">Cache parent function given to child if dependencies not changed.</p>
            </div>
